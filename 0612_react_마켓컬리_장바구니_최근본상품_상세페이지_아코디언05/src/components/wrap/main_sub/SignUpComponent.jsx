...
export default function SignUpComponent({회원가입, timer,timerCounterfn,mapAddressFn,confirmModalOpen,openPopupDaumPostApi,addr}) {
    //상위컴포넌트(wrap) 프롭스
    ...
    const onClickHpNum2=(e)=>{
        ...
        confirmModalOpen(confirmModalMsg);
    ...
    React.useEffect(()=>{ //useEffect=> state뭔가 변화가 생기면 그때 실행 
        getSessionStorage();
    },[state,addr.주소1,addr.주소2,addr.isAddr]);
    ...
    // })
        ...
        //13.이용약관동의 : 필수항목 3개 확인 추가검증
           ...
           // console.log(cnt);
            ...
            confirmModalOpen('아이디 중복확인을 입력하세요');
                ...
                confirmModalOpen('비밀번호를 한번 더 입력하세요');
                ...
                confirmModalOpen('이용약동의 필수항목 3개를 선택해야합니다.');
                ...
                //1.서블릿컨테이너(톰캣서버 켜기)
                //2.JSP kurly_user_signup_action.jsp 액션파일 웹문서 상단 헤더에 CORS 추가
                
                
                //http://localhost:8080/JSP/0512AJAX_DTO_DAO/쇼핑몰고객관리0512/kurly_user_signup_action.jsp
                //http://127.0.0.1:8080/JSP/0512AJAX_DTO_DAO/쇼핑몰고객관리0512/kurly_user_signup_action.jsp
                //http://192.168.40.149/JSP/0512AJAX_DTO_DAO/쇼핑몰고객관리0512/kurly_user_signup_action.jsp

                //AJAX 

                // $.ajax({
                //     url: 'http://localhost:8080/JSP/0512AJAX_DTO_DAO/쇼핑몰고객관리0512/kurly_user_signup_action.jsp',
                //     type:'POST',
                //     data:formData,
                //     success(res){
                //         console.log( 'AJAX 성공');
                ...
                //         ///이거 꼭 여기에 넣어야해!!!! 다 검증거치고 마지막에 처리해!!!
                //         setState({
                //             ...state,
                //             isConfirmModal:true,
                //             confirmModalMsg:'회원가입을 축하드립니다.'
                ...
                // });
                //[3]FETCH() 
                // fetch('/JSP/0516마켓컬리_AJAX_DTO_DAO/쇼핑몰고객관리0516/kurly_user_signup_action.jsp',{
                //     method:'POST',
                //     body:formData
                // })
                // .then((res)=> res.json())
                ...
                //[2-1]AXIOS() GET 구현(축약!!!!!!)=> 1.url package json에서 proxy 설정
                // axios.get('/JSP/0516마켓컬리_AJAX_DTO_DAO/쇼핑몰고객관리0516/kurly_user_signup_action.jsp',
                // {
                //     params:formData
                // })
                // .then((res)=>{
                ...
                //[2-2]AXIOS() GET 구현=> 1.url package json에서 proxy 설정
                // axios({
                //     url:'/JSP/0516마켓컬리_AJAX_DTO_DAO/쇼핑몰고객관리0516/kurly_user_signup_action.jsp',
                //     method:'GET',
                //     params:formData
                // })
                // .then((res)=>{
                ...
                //[1]AXIOS() POST 구현=> 1.url package json에서 proxy 설정
                ...
                axios({
                    //url:'/JSP/0516마켓컬리_AJAX_DTO_DAO/쇼핑몰고객관리0516/kurly_user_signup_action_test_parameter.jsp',
                    //url:'/JSP/0516마켓컬리_AJAX_DTO_DAO/쇼핑몰고객관리0516/kurly_user_signup_action_test_useBean.jsp',
                    url:'/JSP/0516마켓컬리_AJAX_DTO_DAO/쇼핑몰고객관리0516/kurly_user_signup_action.jsp',
                    method:'POST', //get 다 보여 post 안보여
                    data:{},
                    params:formData
                })
                .then((res)=>{
