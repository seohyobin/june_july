...
export default function WrapComponent(){
   ...
   const postCodeOpen=()=>{
    ...
    return (
        <div id='wrap'>
            <GlobalContext.Provider value={{CARTPRODUCTKEY,VIEWPRODUCTKEY,TOPMODALKEY,ADDRESSKEY,isAdmin,mainModal,mainModalshowOut,mainModalAyearshowOut,addressAuto,postCodeOpen,postCodeClose,login,setLogin}}>
