        ...
        <div id='wrap'>
            {
                topModal.isTopModal&&<TopModalComponent  topModalClose={topModalClose}/>
                    ...
                    <BrowserRouter basename={process.env.PUBLIC_URL}>
                        <Routes>
                            <Route path='/' element={<HeaderComponent cartCountNunber={cartCountNunber} setIsIntroFn={setIsIntroFn} MapText={state.MapText} isMap={state.isMap} cartCount={cartCount}/>}>
                                ...
                                <Route path='/cart' element={<CartComponent key={key}  confirmModalOpen={confirmModalOpen}/>}/>
                            </Route>
                        </Routes>
                    </BrowserRouter>
