...
import './go_top/scss/post_code.scss';
import { GlobalContext } from '../../context/GlobalContext';
export default function PostCodeComponent(){
    const {ADDRESSKEY,addressAuto,postCodeOpen,postCodeClose}=React.useContext(GlobalContext,);
    ...
    //주소저장 버튼 클릭 이벤트
     const onClickSave=(e)=>{
        ...
        sessionStorage.setItem(ADDRESSKEY,JSON.stringify(addr));
        addressAuto();  
                        ...
                        <div className="content1">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <a className="more-view-btn" href="!#">자세히 보기 <img src="./images/pop_up/ico_arrow_down_11x10.svg" alt=""/></a>
                                    <div className="sub">
                                        <ul>
                                            <li>가락동농수산물도매시장</li>
                                            <li>가락동농수산물시장</li>
