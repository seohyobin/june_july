...
{"아이디" :  " <%= userDTO.getUser_id() %>" , "비밀번호" :" <%= userDTO.getUser_pw() %>" , "이름" :    " <%= userDTO.getUser_name() %>" , "이메일" :  " <%= userDTO.getUser_email() %>" , "전화번호" :" <%= userDTO.getUser_hp() %>" , "주소" :    " <%= userDTO.getUser_address() %>" , "성별" :    " <%= userDTO.getUser_gender() %>" , "생년월일" :" <%= userDTO.getUser_birth() %>" , "추가" :    " <%= userDTO.getUser_chooga() %>" , "이용약관" :" <%= userDTO.getUser_service() %>" }
