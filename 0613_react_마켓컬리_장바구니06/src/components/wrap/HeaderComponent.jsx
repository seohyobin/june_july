...
export default function HeaderComponent({MapText,isMap,setIsIntroFn,cartCount,cartCountNunber,openPopupDaumPostApi,addr}) {

    React.useEffect(()=>{
        if(localStorage.getItem('HB_KURLY_CART_PRODUCT')!==null){
            let arr = JSON.parse(localStorage.getItem('HB_KURLY_CART_PRODUCT'));
